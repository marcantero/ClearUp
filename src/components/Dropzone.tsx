    ...
    <div className="w-full">
      ...
      <div
        ...
        className={[
          ...
          disabled
            ...
            : isDragOver
            ? 'border-red-400/50 bg-red-400/[0.04] ring-1 ring-red-400/20'
      ...
      >
        ...
        <div className="text-center">
          <p className={`text-sm font-medium transition-colors ${isDragOver ? 'text-red-300' : 'text-slate-300 group-hover:text-slate-200'}`}>
